    ...
    public render() {
        ...
        return (
            <div className="container meme-wrapper">
                ...
                <div className="row meme-date">{currentMeme.uploaded}</div>
                <div className="row meme-img">
                    <img src={currentMeme.url} />
                </div>

                <div className="row meme-done-button">
                    <div className="btn btn-primary btn-action" onClick={this.downloadMeme.bind(this, currentMeme.url)}>
                        Download{" "}
                    </div>
                    <div className="btn btn-primary btn-action" onClick={this.onOpenModal}>
                        Edit{" "}
                    </div>
                    <div className="btn btn-primary btn-action" onClick={this.deleteMeme.bind(this, currentMeme.id)}>
                        Delete{" "}
                    </div>
                </div>
                    ...
                    <form>
                        ...
                        <div className="form-group">
                            ...
                            <input
                                type="text"
                                className="form-control"
                                id="meme-edit-tag-input"
                                placeholder="Enter Tag"
                            />
                            <small className="form-text text-muted">Tag is used for search</small>
                        </div>
                        <button type="button" className="btn" onClick={this.updateMeme}>
                            Save
                        </button>
                    </form>
                </Modal>
