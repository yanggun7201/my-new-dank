            ...
            <div>
                <div className="header-wrapper">
                    <div className="container header">
                        ...
                        <div className="btn btn-primary btn-action btn-add" onClick={this.onOpenModal}>
                            Add Meme
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-5">
                            <MemeList
                                ...
                                selectNewMeme={this.selectNewMeme}
                                searchByTag={this.fetchMemes}
                            />
                        </div>
                    </div>
                </div>
                <Modal open={open} onClose={this.onCloseModal}>
                    <form>
                        ...
                        <button type="button" className="btn" onClick={this.uploadMeme}>
                            Upload
                        </button>
                    </form>
                </Modal>
